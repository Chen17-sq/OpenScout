```
VOL. 1 · NO. 045                              BEIJING EDITION
DAILY · 具身 / 世界模型 / AI4SCI · SUNDAY, JUNE 28, 2026
```

# OpenScout

> *All The Researchers Fit To Watch* — Vol. 1, No. 045 · 2026-06-28

_Auto-generated at 2026-06-28T05:36:42+00:00 · [完整看板](http://localhost:5174) · [API](/briefs/today)_
...
### No. 01 · saCI: An R Package for Stochastic Approximation Confidence Intervals for Correlation Coefficients

**Pengyu Chen** · 一作 · 3 作者 · [arXiv:2606.04417](https://arxiv.org/abs/2606.04417)

*用随机逼近法构建相关系数的非参数置信区间。*

_This paper presents saCI, an R package that implements the stochastic approximation method for constructing nonparametric confidence intervals for Pearson's correlation coefficient. The package is based on the algorithm…_

→ [profile](/researchers/pengyu-chen)
...
---
### No. 06 · Why Personalizing Deep Learning-Based Code Completion Tools Matters
...
---
### No. 07 · InstructMix2Mix: Consistent Sparse-View Editing Through Multi-View Model Personalization
